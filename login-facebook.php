...
define('CLIENT_ENABLED', get_option('rs_facebook_api_enabled'));
define('CLIENT_ID', get_option('rs_facebook_api_id'));
define('CLIENT_SECRET', get_option('rs_facebook_api_secret'));
