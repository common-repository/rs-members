...
define('CLIENT_ENABLED', get_option('rs_instagram_api_enabled'));
define('CLIENT_ID', get_option('rs_instagram_api_id'));
define('CLIENT_SECRET', get_option('rs_instagram_api_secret'));
